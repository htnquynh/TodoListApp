...
<%
	...
	<% 	
		...
		if(sort==null)
			sort="rong";
		System.out.println("trang index "+ sort);
	%>
    ...
    <div class="main-container">
        ...
        <div class="buttons-container">
            <div class="buttons-on-left">
                <a href="${pageContext.request.contextPath}/listTodo" class="btn-view-todos" id="on-view">
                    Day
                </a>
		            ...
		            <div class="mymodal-body">
		                ...
		                <div class="form-container">
		                    ...
		                    <div class="controls-watch">
		                        ...
		                        <a id="stop" href="${pageContext.request.contextPath}/updateStartEnd?from=tododay&">
                ...
                <div class="tags-inner-container">
                    ...
                    <c:forEach var="tag" items="${sessionScope.listTag}">  
                        <div class="tag" style="background-color: <c:out value="${tag.color}"></c:out>;">  
                            ...
                            <a href="${pageContext.request.contextPath}/editTag?id=<c:out value='${tag.id}'/>&from=tododay" class="btn-on-tag">
                                <span>
                            ...
                            <a href="${pageContext.request.contextPath}/deleteTag?id=<c:out value='${tag.id}'/>&from=tododay" class="btn-on-tag">
                                <span>
                        ...
                        <!-- <h2 class="title-form">Filter todo</h2> -->
                            <div class="form-container">
                                <div class="input-date">
                                    ...
                                    <input type="date" name="datefilter" id="datefilter" value="<%= datefilter%>">
                                </div>
                ...
                <c:if test="${todo.priority.equals('High')}">
                   ...
                   <!--  <div class="task-container"> -->
                        <div class="done-area">
                            ...
                            <a href="${pageContext.request.contextPath}/UpdateStatusTodo?id=<c:out value='${todo.id}' />&from=tododay" class="btn-done">
                        ...
                        <div class="buttons-area">
                            ...
                            <a href="${pageContext.request.contextPath}/editTodo?id=<c:out value='${todo.id}'/>&from=tododay" class="btn-on-todo">
                                 <svg fill="currentColor" viewBox="0 0 16 16">
                                     <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5L13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175l-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/>
                                 </svg>
                            </a>
                
                            <a href="${pageContext.request.contextPath}/deleteTodo?id=<c:out value='${todo.id}'/>&from=tododay" class="btn-on-todo">
                                 <svg fill="currentColor" viewBox="0 0 16 16">
                                     <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"/>
                                     <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
                                 </svg>
