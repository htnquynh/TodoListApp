...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/dashboardmain.css">
    ...
    <div class="main-container">
        <div class="navbar-container">
            <div class="navbar">
                ...
                <div class="nav-links">
                    <a href="${pageContext.request.contextPath}/listDashboard" class="link-on-navbar" id="active">
                        <span>
			...
			<div class="tags-inner-container">
				<div class="tags-list">
					...
					<div class="tag" style="background-color: <c:out value="${tag.color}"></c:out>;">  
					 	<p id="tag<c:out value="${tag.id}"></c:out>" class="tagname">
					  		<c:out value="${tag.tagname}"></c:out>
						</p>
					       
					  	<a href="${pageContext.request.contextPath}/editTag?id=<c:out value='${tag.id}'/>&from=dashboard" class="btn-on-tag">
					           <span>
					 	...
					 	<a href="${pageContext.request.contextPath}/deleteTag?id=<c:out value='${tag.id}'/>&from=dashboard" class="btn-on-tag">
					           <span>
        ...
        <div class="buttons-container">
			...
			<!-- Button: Filter todo -->
            <a id="btn-open-filterTodoModal" class="btn-open-mymodal">
                <svg fill="currentColor" viewBox="0 0 16 16">
                    <path shape-rendering="crispEdges" fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
                </svg>
                Fiter todo
            </a>
            
            <!-- Form: Filter todo -->
            <div class="mymodal" id="filterTodoModal">
                <div class="mymodal-content">
                    <form>
                        <div class="mymodal-header">
                            <h3>Filter todo</h3>
                            <a class="btn-close-mymodal" id="btn-close-filterTodoModal">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
                                        <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
                                    </svg>
                            ...
                            <div class="form-container">
                                ...
                                <div class="input-select">
                                    ...
                                    <select name="select-tag">
                                        <option value="one" >Study</option>
                                        <option value="two">Work</option>
                                        <option value="three">Play</option>
                                    </select>
                                </div>

                                <div class="input-select">
                                    <label for="select-priority">Priority</label>
                                    <select name="select-priority">
                   		...
                   		<div class="mymodal-body">
                       		<div class="form-container">
                        		...
                        		<div class="input-time">
                         		...
                         		<div class="input-time">
                           			<label for="remindat">Deadline</label>
		        ...
		        <div class="mymodal-content">
		            ...
		            <div class="mymodal-body">
		                ...
		                <div class="form-container">
		                    ...
		                    <div class="controls-watch">
		                        <a id="start">
		                            
		                                <img id="playButton"  src="${pageContext.request.contextPath}/assets/play_circle_black_24dp.svg"  />
		                            
		                        </a>
		
		                        <a id="stop" href="${pageContext.request.contextPath}/updateStartEnd?from=dashboard&">
		        
		                                <img id="pauseButton" src="${pageContext.request.contextPath}/assets/pause_black_24dp.svg" />
		            ...
		            <div class="mymodal-footer">
	                    ...
	                    <div class="controls">
	                        <a id="start" class="button-for-focus">
	                            
	                                <img id="playButton" src="${pageContext.request.contextPath}/assets/play_circle_black_24dp.svg"  />
	                            
	                        </a>
	
	                        <a id="stop" class="button-for-focus" href="${pageContext.request.contextPath}/updateStartEnd?from=dashboard&">
        ...
        <div class="center-content">
        	<div class="tasks-container">
                ...
                <c:forEach var="todo" items="${sessionScope.listTodo}">
                   ...
                   <c:if test="${todo.priority.equals('Low')}">
                        ...
                        <div class="done-area">
                            ...
                            <a href="${pageContext.request.contextPath}/UpdateStatusTodo?id=<c:out value='${todo.id}'/>&from=dashboard" class="btn-done">
                            	<svg fill="currentColor" viewBox="0 0 16 16">
                        ...
                        <div class="buttons-area">
                            ...
                            <a href="${pageContext.request.contextPath}/editTodo?id=<c:out value='${todo.id}'/>&from=dashboard" class="btn-on-todo">
                                <svg fill="currentColor" viewBox="0 0 16 16">
                                    <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5L13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175l-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/>
                                </svg>
                            </a>
                
                            <a href="${pageContext.request.contextPath}/deleteTodo?id=<c:out value='${todo.id}'/>&from=dashboard" class="btn-on-todo">
                                <svg fill="currentColor" viewBox="0 0 16 16">
                                    <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"/>
                                    <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
                                </svg>
