...
<%
	...
	<% 	
		...
		System.out.println("trang week tuan"+ week);
		String sort=request.getParameter("sort");
		if(sort==null)
			sort="";
		System.out.println("trang week"+ sort);
	%>
    ...
    <div class="main-container">
            ...
            <div class="navbar">
                ...
                <div class="nav-menu-dropdown">
                    ...
                    <div class="dropdown" style="display: none;">
                        <a href="${pageContext.request.contextPath}/dashboard.html" class="link-on-dropdown" >
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-ui-checks-grid" viewBox="0 0 16 16">
                                    <path d="M2 10h3a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1zm9-9h3a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-3a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1zm0 9a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1h-3zm0-10a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h3a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2h-3zM2 9a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h3a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2H2zm7 2a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2h-3a2 2 0 0 1-2-2v-3zM0 2a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2zm5.354.854a.5.5 0 1 0-.708-.708L3 3.793l-.646-.647a.5.5 0 1 0-.708.708l1 1a.5.5 0 0 0 .708 0l2-2z"/>
                                </svg>
                        ...
                        <a href="${pageContext.request.contextPath}/tododay.html" class="link-on-dropdown">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check2" viewBox="0 0 16 16">
                                    <path d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z"/>
                                </svg>
                        ...
                        <a href="${pageContext.request.contextPath}/statistic.html" class="link-on-dropdown">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bar-chart" viewBox="0 0 16 16">
                                    <path d="M4 11H2v3h2v-3zm5-4H7v7h2V7zm5-5v12h-2V2h2zm-2-1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1h-2zM6 7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V7zm-5 4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1v-3z"/>
                                </svg>
                        ...
                        <a href="${pageContext.request.contextPath}/profile.html" class="link-on-dropdown">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
                                    <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
                                </svg>
        ...
        <div class="buttons-container">
            <div class="buttons-on-left">
                ...
                <a href="${pageContext.request.contextPath}/listTodoThisWeek" class="btn-view-todos" id="on-view">
                    Week
                </a>

                <a href="${pageContext.request.contextPath}/listTodoThisMonth" class="btn-view-todos" >
                    Month
                </a>
		            ...
		            <div class="mymodal-body">
		                ...
		                <div class="form-container">
		                    ...
		                    <div class="controls-watch">
		                        ...
		                        <a id="stop" href="${pageContext.request.contextPath}/updateStartEnd?from=todoweek&">
                ...
                <div class="tags-inner-container">
                    ...
                    <c:forEach var="tag" items="${sessionScope.listTag}">  
                        <div class="tag" style="background-color: <c:out value="${tag.color}"></c:out>;">  
                            ...
                            <a href="${pageContext.request.contextPath}/editTag?id=<c:out value='${tag.id}'/>&from=todoweek" class="btn-on-tag">
                                <span>
                            ...
                            <a href="${pageContext.request.contextPath}/deleteTag?id=<c:out value='${tag.id}'/>&from=todoweek" class="btn-on-tag">
                                <span>
                   ...
                   <form action="${pageContext.request.contextPath}/filterTodo" method="post">
                        <!-- <h2 class="title-form">Filter todo</h2> -->
                            <div class="form-container">
    							...
    							<input type="hidden" value="week" name="type">
    							<input type="hidden" value="date" name="type">
    							<label style="display: block;line-height: 1.5;">
								  	<input type="checkbox" style="margin-right: 8px; margin-left: 8px;" id="sort" name="sort" value="Sort" <% if (sort.equals("Sort")) { %> checked <% } %>>
									Sort by level and progress of the task
								</label>
                   ...
                   <c:if test="${todo.priority.equals('Low')}">
                    ...
                    <!-- <div class="task-container"> -->
                        <div class="done-area">
                            ...
                            <a href="${pageContext.request.contextPath}/UpdateStatusTodo?id=<c:out value='${todo.id}'/>&from=todoweek" class="btn-done">
                        ...
                        <div class="buttons-area">
                            ...
                            <a href="${pageContext.request.contextPath}/editTodo?id=<c:out value='${todo.id}'/>&from=todoweek" class="btn-on-todo">
                                    <svg fill="currentColor" viewBox="0 0 16 16">
                                        <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5L13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175l-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/>
                                    </svg>
                            </a>
                
                            <a href="${pageContext.request.contextPath}/deleteTodo?id=<c:out value='${todo.id}'/>&from=todoweek" class="btn-on-todo">
                                    <svg fill="currentColor" viewBox="0 0 16 16">
                                        <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"/>
                                        <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
                                    </svg>
